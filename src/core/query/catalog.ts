...
export const DATASET_CATALOG: Record<DatasetName, DatasetDefinition> = {
  ...
  daily_health: {
    name: 'daily_health', relation: 'daily_health', description: 'Daily health projection. Garmin is canonical for device-health facts, but provider values remain separate.', dateColumn: 'metric_date', provenanceColumns: ['provider'], permittedGroupings: ['provider'],
